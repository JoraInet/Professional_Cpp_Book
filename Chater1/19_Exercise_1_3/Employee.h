...
namespace HR {
    ...
    Employee CreateNewEmployee(char firstInitial, char lastInitial, int employeeNumber = 0,
        int salary = 10000, EmployeeTitle title = EmployeeTitle::Engineer)
    {
        Employee newEmployee;
        newEmployee.firstInitial = firstInitial;
        newEmployee.lastInitial = lastInitial;
